...
], function (declare, Core, dojoAttr, dojoStyle, dojoClass, dojoLang, dojoQuery, _TemplatedMixin, widgetTemplate) {
	"use strict";

	return declare("GridSearch.widget.GridSearch", [Core, _TemplatedMixin], {
